# <a href="https://todonot.web.app">Todo&not;</a>

A simple to-do list progressive web app using React, Redux, Bootstrap and Firebase.

This project was bootstrapped with [Create React App](https://github.com/facebook/create-react-app) and [Firebase Tools](https://firebase.google.com/docs/cli).
